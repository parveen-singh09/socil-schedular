        ...
        <div className="analytics-chart-card">
          ...
          <div className="svg-chart-container">
            <svg viewBox="0 0 400 200" width="100%" height="100%">
              ...
              <path d="M 40 150 Q 90 90 140 120 T 240 60 T 340 40 L 380 50" fill="none" stroke="#8b5cf6" strokeWidth="3" />
              <path d="M 40 150 Q 90 90 140 120 T 240 60 T 340 40 L 380 50 L 380 170 L 40 170 Z" fill="url(#gradient-glow)" />
              <circle cx="90" cy="115" r="4" fill="#ec4899" />
              <circle cx="190" cy="95" r="4" fill="#ec4899" />
              <circle cx="290" cy="48" r="4" fill="#ec4899" />
